...
This IP is able to run up to 2000 cells per ZedBoard for a system with four ZedBoards. So, the maximun network size that may be simulated is of 8000 cells. These sizes may be edited on projectsource files if a bigger platform is used.
