...
This directory contains the bitstream of the system generated by Vivado  2016.4

This bitstream was generated to run 2000 cells per ZedBoard for a system with 4 ZedBoards. So, total size of the network is 8000 cells.
